...
\begin{tabularx}{\linewidth}{@{}>{\bfseries\color{uteqBlue}}p{3.2cm} X >{\bfseries\color{uteqBlue}}p{2.6cm} X@{}}
    ...
    Entregable & Documento en LaTeX, compilado (.tex). Minimo 5 paginas de contenido. & Calificacion & 0 -- 10 puntos \\
...
\begin{itemize}
    \item Documento elaborado en LaTeX y compilable sin errores con \texttt{pdflatex}; se entrega el archivo \texttt{.tex} sin errores y compilable correctamente.
...
\begin{tabularx}{\linewidth}{@{}>{\RaggedRight}p{3.0cm} >{\RaggedRight}p{3.5cm} >{\RaggedRight}p{7cm} >{\RaggedRight}p{4.5cm} >{\RaggedRight}p{3.7cm} >{\RaggedRight}p{2.4cm}@{}}
