...
sub SQLITE_DBCONFIG_ENABLE_ATTACH_CREATE() ;
sub SQLITE_DBCONFIG_ENABLE_ATTACH_WRITE() ;
sub SQLITE_DBCONFIG_ENABLE_COMMENTS() ;
...
sub SQLITE_SCHEMA() ;
sub SQLITE_SELECT() ;
sub SQLITE_SELFORDER1() ;
sub SQLITE_SETLK_BLOCK_ON_CONNECT() ;
sub SQLITE_SUBTYPE() ;
sub SQLITE_TEXT() ;
sub SQLITE_TOOBIG() ;
...
sub _const_database_connection_configuration_options_3049000() ;
...
sub _const_extended_result_codes_3051000() ;
...
sub _const_flags_for_sqlite3_setlk_timeout_3050000() ;
...
sub _const_function_flags_3047000() ;
...
sub Rmpfr_atanu;
sub Rmpfr_beta;
sub Rmpfr_buildopt_bfloat16_p;
sub Rmpfr_buildopt_decimal_p;
sub Rmpfr_buildopt_float128_p;
sub Rmpfr_buildopt_float16_p;
...
sub _gmp_fprintf_nv;
sub _gmp_printf_nv;
sub _gmp_snprintf_nv;
sub _gmp_sprintf_nv;
sub _has_bizarre_infnan;
sub _has_longdouble;
sub _has_longlong;
sub _has_pv_nv_bug;
...
sub _nvtoa;
sub _overload_fmod;
sub _overload_fmod_eq;
sub _overload_lshift;
sub _overload_lshift_eq;
sub _overload_rshift;
sub _overload_rshift_eq;
sub _readonly_off;
sub _readonly_on;
...
sub _sizeof_prec;
sub _strlen;
sub _subnormalize_pv;
sub _unpack_bfloat16;
sub _unpack_float16;
sub _unpack_float32;
sub _win32_infnanstring;
sub _wrap_count;
...
sub _is_congruent_number_filter($) ;
sub _is_congruent_number_tunnell($) ;
...
sub CTX_sessions($) ;
sub CTX_set1_client_sigalgs_list($$) ;
sub CTX_set1_curves_list($$) ;
sub CTX_set1_groups_list($$) ;
sub CTX_set1_param($$) ;
sub CTX_set1_sigalgs_list($$) ;
...
sub session_reused($) ;
sub set1_client_sigalgs_list($$) ;
sub set1_curves_list($$) ;
sub set1_groups_list($$) ;
sub set1_param($$) ;
sub set1_sigalgs_list($$) ;
sub set_SSL_CTX($$) ;
...
sub ErrorString;
sub ExpatVersion;
sub ExpatVersionInfo;
sub FreeEncoding;
sub GenerateNSName;
sub GetBase;
sub GetCurrentByteCount;
