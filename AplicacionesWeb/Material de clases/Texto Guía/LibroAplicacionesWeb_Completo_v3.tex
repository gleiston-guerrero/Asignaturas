...
{\Large\itshape Edición completa: historia, fundamentos detallados, prácticas paso a paso y buenas prácticas profesionales}\\[0.3cm]
{\color{uteqverde}\rule{\linewidth}{1pt}}\\[1.2cm]
{\Large\bfseries Libro de texto académico}\\[0.3cm]
{\large Edición completa --- Semanas 1 a 18}\\[0.5cm]
{\large Unidad I: \emph{Fundamentos y Diseño Web}}\\
{\large Unidad II: \emph{Programación Web del Lado del Servidor}}\\
...
\thispagestyle{empty}
\vspace*{2cm}
\noindent\textbf{APLICACIONES WEB --- Edición completa (Semanas 1 a 18)}\\[0.3cm]
\noindent Universidad Técnica Estatal de Quevedo, 2026.\\
Facultad de Ciencias de la Computación.\\
Carrera de Ingeniería de Software (Rediseño).\\[0.4cm]
\noindent Esta edición completa reúne las cuatro unidades de la
asignatura en un único volumen y abarca las dieciocho semanas del
período académico. Incorpora un tratamiento profundo de la historia
del desarrollo web, fundamentos teóricos extensos, ejercicios paso a
paso plenamente reproducibles en IntelliJ IDEA Ultimate, tablas
comparativas de versiones de tecnologías y secciones dedicadas a
buenas prácticas profesionales para cada tecnología abordada. Su
contenido se ha alineado con el SWEBOK Guide v4.0
...
La presente edición completa del libro \emph{Aplicaciones
...
El libro se organiza en cuatro unidades que se corresponden con las
cuatro unidades curriculares de la asignatura y con las dieciocho
semanas del período académico. Cada unidad agrupa los capítulos
semanales que la integran, de modo que la numeración de capítulos
coincide con la numeración de semanas (Capítulo~$n$ $=$ Semana~$n$):

\begin{center}
\renewcommand{\arraystretch}{1.3}
\begin{tabular}{>{\raggedright\arraybackslash}p{4.3cm}cc}
\toprule
\textbf{Unidad} & \textbf{Semanas} & \textbf{Capítulos} \\
\midrule
I --- Fundamentos y Diseño Web & 1--4 & 1--4 \\
II --- Programación Web del Lado del Servidor & 5--9 & 5--9 \\
III --- Datos y Patrones Arquitectónicos & 10--13 & 10--13 \\
IV --- Patrón MVC y Servicios Web & 14--18 & 14--18 \\
\bottomrule
\end{tabular}
\end{center}

Cada capítulo combina, de forma sistemática, una contextualización
histórica, el desarrollo teórico riguroso del tema, prácticas
reproducibles y un bloque de buenas prácticas profesionales, además de
los ejercicios y, en las semanas correspondientes, las evaluaciones
parciales y los hitos del Proyecto Final de Curso (PFC).
...
%                     UNIDAD II  ---  PARTE II
% =====================================================================
\part{Programación Web del Lado del Servidor}
\label{parte:unidad2}
...
% La numeración de capítulos continúa de forma corrida: las semanas 1-9
% son los capítulos 1-9; a partir de aquí, capítulo = semana.
