...
% Comando para rutas largas que se cortan en cualquier caracter
\newcommand{\rutafmt}[1]{{\footnotesize\ttfamily\seqsplit{#1}}}
...
Estándar base: & Norma internacional emitida conjuntamente por la Organización Internacional de Normalización\footnote{En inglés: \emph{International Organization for Standardization}, ISO, organismo internacional con sede en Ginebra, Suiza, encargado de la elaboración de normas técnicas voluntarias.} (ISO), la Comisión Electrotécnica Internacional\footnote{En inglés: \emph{International Electrotechnical Commission}, IEC, organismo internacional encargado de la normalización en el campo de la electrotecnología, con sede en Ginebra, Suiza.} (IEC) y el Instituto de Ingenieros Eléctricos y Electrónicos (IEEE), identificada como ISO/IEC/IEEE 29148:2018 --- Ingeniería de sistemas y de software: procesos del ciclo de vida e ingeniería de requisitos\footnote{En inglés: \emph{Systems and software engineering --- Life cycle processes --- Requirements engineering}.} \cite{ieee29148_2018}, y norma ISO/IEC 25010:2023 --- Modelo de calidad del producto\footnote{En inglés: \emph{Systems and software Quality Requirements and Evaluation (SQuaRE) --- Product quality model}.} \cite{iso25010_2023}.\\
...
Modalidad: & Grupal (3--4 integrantes) · Sistema de software \textbf{real} en cualquier dominio verificable (salud, agroindustria, educación, servicios, comercio, etc.)\\
Repositorio: & Repositorio en GitHub obligatorio · Conjunto de datos abierto con Identificador de Objeto Digital\footnote{En inglés: \emph{Digital Object Identifier}, DOI, identificador persistente que apunta de forma unívoca a un recurso digital y su descripción en línea.} (DOI) en Zenodo o en el Marco de Ciencia Abierta\footnote{En inglés: \emph{Open Science Framework}, OSF, plataforma pública de la Center for Open Science para el registro previo de protocolos y el depósito de materiales de investigación (\url{https://osf.io}).} (OSF)\\
Entregable: & Documento de Especificación de Requisitos de Software\footnote{En inglés: \emph{Software Requirements Specification}, SRS. En español se usa la sigla ERS por \emph{Especificación de Requisitos de Software}. En esta guía se usa la notación combinada ERS/SRS para conservar ambas convenciones.} (ERS/SRS) completo en formato Formato de Documento Portátil\footnote{En inglés: \emph{Portable Document Format}, PDF, formato de archivo estandarizado por la Organización Internacional de Normalización (ISO 32000) para el intercambio de documentos electrónicos preservando su presentación visual independientemente del entorno.} (PDF) $+$ protocolo experimental $+$ conjunto de datos FAIR\footnote{Acrónimo en inglés de \emph{Findable, Accessible, Interoperable, Reusable}: localizable, accesible, interoperable y reutilizable \cite{wilkinson2016fair}.}\\
Publicación: & Búsqueda de revista objetivo en modalidad mixta, es decir con revistas de acceso por Cargo por Procesamiento de Artículo\footnote{En inglés: \emph{Article Processing Charge}, APC, tarifa pagada por las personas autoras o por sus instituciones para que un artículo sea publicado en régimen de acceso abierto inmediato, sin barrera de pago para la persona lectora.} (APC, acceso abierto) y revistas por suscripción, indexadas en el Informe de Citas de Revistas\footnote{En inglés: \emph{Journal Citation Reports}, JCR, base de datos anual publicada por Clarivate Analytics que reporta los indicadores bibliométricos oficiales (entre ellos el factor de impacto) de las revistas indexadas en la Web of Science, base sobre la que se determinan los cuartiles Q1--Q4 usados como referencia de alto impacto.} (JCR) de la empresa Clarivate Analytics\\
Semana: & 13 del Período Académico Ordinario (PPA) 2026--2027 (Primera entrega del segundo parcial)\\
Corte: & Miércoles 29 de julio de 2026, 00:00 (fecha del último commit válido en el repositorio)\\
\end{tabularx}
\end{notabox}
...
La Entrega 3 (2A) toma como línea base los mejores documentos entregados en la Entrega 2 (1B) del corte anterior --- sin distinguir un dominio en particular, ya que los equipos trabajan sistemas de software reales muy diversos (plataformas veterinarias, sistemas agroindustriales de trazabilidad, aulas inteligentes, aplicaciones de transporte universitario, plataformas de gestión clínica, entre otros) --- y eleva el estándar de exigencia de todos los equipos hacia dos objetivos simultáneos: (i) consolidar un ERS/SRS completo, verificable y validado con evidencia real de campo, y (ii) generar el instrumental empírico que permitirá que la Entrega 4 (2B/Defensa) produzca los datos suficientes para una publicación de alto impacto en el área de Ingeniería de Requerimientos, alineada con los temas activos de investigación en Inteligencia Artificial Generativa\footnote{En inglés: \emph{Generative AI}, GenAI. Se refiere a familias de modelos --- típicamente LLM --- capaces de producir texto, código, imágenes u otros artefactos digitales.} (IAG) aplicada a la Ingeniería de Requerimientos \cite{cheng2026genai,arora2024llm4re,vogelsang2024llm} y en explicabilidad como Requisito No Funcional\footnote{En inglés: \emph{Non-Functional Requirement}, NFR. En español también se usa el equivalente RNF.} (RNF) \cite{chazette2020nfr,chazette2021exploring,chazette2022explainable}.

Esta guía es transversal a los distintos temas de PFC del paralelo: no importa si el sistema del equipo pertenece al ámbito de la salud animal o humana, de la industria agroalimentaria, de la educación, de la movilidad universitaria, del comercio electrónico o de cualquier otro dominio, ya que los criterios de calidad de los requisitos, los métodos de elicitación, los mínimos evidenciales y las exigencias de los estudios empíricos son los mismos.

\begin{notabox}[title=Estándar mínimo tomado de los mejores documentos de la Entrega 2 (1B)]
Del análisis forense de las Entregas 2 (1B) mejor calificadas del corte anterior --- tomadas sin distinción de dominio ni de tema --- se destilan los siguientes elementos que constituyen el estándar mínimo esperado para todos los equipos en esta Entrega 3 (2A):
\begin{itemize}
    ...
    \item Seis (6) videos reales de entrevistas con codec Codificación Avanzada de Video\footnote{En inglés: \emph{Advanced Video Coding}, AVC, también conocido como H.264, estándar de compresión de video ampliamente utilizado, estandarizado conjuntamente por la International Telecommunication Union (ITU-T) y la ISO/IEC.} (AVC/H.264), con duración total superior a los 70 minutos, alojados como archivos MPEG-4 Parte 14\footnote{En inglés: \emph{Moving Picture Experts Group}-4 Part 14, MP4, formato contenedor multimedia estandarizado (ISO/IEC 14496-14) que aloja video, audio, subtítulos y metadatos en un único archivo.} (MP4) dentro del repositorio.
    \item Cinco (5) audios reales de entrevistas con duración total superior a los 50 minutos.
    \item Cuestionario aplicado a por lo menos tres perfiles de usuario con respuestas exportadas en PDF y en formato de Hoja de Cálculo de Microsoft Excel\footnote{En inglés: \emph{Excel Spreadsheet}, XLSX, formato estandarizado por la ISO/IEC 29500 para hojas de cálculo, basado en Office Open XML.} (XLSX).
    \item Cuatro (4) prototipos de interfaz (\emph{mockups}) formales trazados a requisitos funcionales verificables como archivos Gráficos de Red Portables\footnote{En inglés: \emph{Portable Network Graphics}, PNG, formato de imagen sin pérdida estandarizado por la ISO/IEC 15948, muy usado para capturas y prototipos.} (PNG).
...
\begin{pubbox}[title=Objetivo terminal (Entrega 4): publicación de alto impacto en revista con o sin APC]
Al terminar el semestre, cada equipo debe haber producido: (i) un manuscrito redactado con la plantilla oficial de la revista objetivo, seleccionada a partir del título y del resumen mediante las herramientas oficiales de las editoriales principales (véase Sección 6.3); (ii) un conjunto de datos con licencia Creative Commons Atribución 4.0 Internacional\footnote{En inglés: \emph{Creative Commons Attribution 4.0 International}, CC BY 4.0, licencia estándar de acceso abierto que permite el uso, la copia, la distribución y la adaptación de la obra dando el crédito correspondiente a las personas autoras.} (CC BY 4.0) depositado en Zenodo con DOI asignado, siguiendo los principios FAIR \cite{wilkinson2016fair}; (iii) el material de replicación (protocolos, guiones, cuestionarios, prompts, transcripciones anonimizadas) publicado en un repositorio archivado en el OSF.
La revista objetivo debe pertenecer a una editorial de alto impacto (Springer Nature, Elsevier o IEEE) y estar indexada en el JCR; el equipo debe presentar en el manuscrito su análisis comparativo entre al menos una revista de acceso abierto con APC y una revista por suscripción o híbrida sin cargo obligatorio, para que el envío final sea coherente con las posibilidades reales de financiamiento del equipo o de la institución.
\end{pubbox}
...
Perspectiva del producto y límite del sistema (diagrama de contexto), clases y características de usuarios, mapa de interesados o partes interesadas (\emph{stakeholders}) con matriz poder/interés, entorno operativo, suposiciones y dependencias, modelado organizacional en el lenguaje distribuido intencional\footnote{En inglés: \emph{distributed intentionality}, denotado con el símbolo i*, lenguaje visual propuesto por Eric Yu (1995) para modelar la intencionalidad de los actores organizacionales; el símbolo i* se lee ``i estrella''.} (i*) con Diagrama de Dependencia Estratégica (SD, del inglés \emph{Strategic Dependency}) y Diagrama de Razón Estratégica (SR, del inglés \emph{Strategic Rationale}).
...
\begin{longtable}{@{}L{0.22\linewidth} L{0.36\linewidth} L{0.36\linewidth}@{}}
    \hh{Tipo de evidencia} & \hh{Cantidad mínima} & \hh{Formato y ubicación}\\
    \endfirsthead
    \hh{Tipo de evidencia} & \hh{Cantidad mínima} & \hh{Formato y ubicación}\\
    \endhead
    Consentimientos firmados & \(\geq 16\) participantes distintos, con avance a \(\geq 24\) para el cierre en la Entrega 4 (2B) & JPG/PNG/PDF\newline\rutafmt{02\_Evidencias/Consentimientos/}\\
    Videos reales de entrevistas & \(\geq 16\) archivos, con duración media individual \(\geq 15\) minutos y duración total \(\geq 240\) minutos & MP4 H.264\newline\rutafmt{02\_Evidencias/Video/}\\
    Audios reales de entrevistas & \(\geq 16\) archivos, redundantes con los videos & MP3/WAV\newline\rutafmt{02\_Evidencias/Audio/}\\
    Fotografías fechadas del entorno & \(\geq 20\) fotos con diversidad de contexto & JPG/PNG con nombre \rutafmt{YYYY-MM-DD\_descripcion.jpg}\\
    Fotografías de la aplicación del cuestionario & \(\geq 5\) fotos & JPG/PNG\newline\rutafmt{02\_Evidencias/Cuestionario/Fotos\_Aplicacion/}\\
    Respuestas del cuestionario & \(n \geq 60\) respuestas por perfil dominante, o justificación con cálculo de potencia estadística (Cohen $d=0{,}5$, $\alpha=0{,}05$, $1-\beta=0{,}80$) \cite{molleri2020checklist} & CSV/XLSX exportado\newline\rutafmt{02\_Evidencias/Cuestionario/Respuestas/}\\
    Documentos originales de la organización cliente & \(\geq 5\) documentos de tipos distintos (por ejemplo: formulario, reporte, factura, hoja de proceso, política interna) & PDF\newline\rutafmt{02\_Evidencias/Documentos\_Organizacion/}\\
    Ronda de validación (walkthrough) con partes interesadas & \(\geq 6\) sesiones grabadas con acta firmada (3 sesiones con usuarios técnicos $+$ 3 sesiones con usuarios no técnicos) & MP4 $+$ PDF de acta firmada\newline\rutafmt{02\_Evidencias/Validacion\_Walkthrough/}\\
    Codificación temática de transcripciones y curva de saturación & Tabla completa $+$ figura de la curva de saturación (códigos nuevos por entrevista) siguiendo \cite{hennink2017saturation} & CSV $+$ PNG/PDF\newline\rutafmt{02\_Evidencias/Codificacion\_Tematica/}\\
\end{longtable}

\begin{notabox}[title=Justificación empírica de los mínimos --- alineación con las revistas indexadas en JCR de Ingeniería de Requerimientos]
Los mínimos exigidos en esta entrega no son arbitrarios; están calibrados con las exigencias que actualmente reportan las revistas indexadas en el JCR del área de Ingeniería de Requerimientos e Ingeniería de Software, sin distinguir editorial particular. En particular:
\begin{itemize}
    ...
    \item El reporte de la curva de saturación es un requisito editorial usual en las revistas indexadas en JCR del área (\cite{hennink2017saturation,mendez2017naming}); su ausencia motiva rechazo de escritorio en revisión.
    \item Los equipos que no logren alcanzar estos mínimos en la Entrega 3 (2A) podrán completarlos hasta la Entrega 4 (2B). Sin embargo, en la Entrega 3 debe demostrarse al menos el 50\% del mínimo (por ejemplo, 8 entrevistas de las 16 mínimas) para conservar el objetivo de envío a revista indexada en JCR; por debajo de ese umbral el equipo deberá redirigir el manuscrito hacia una modalidad de artículo corto (\emph{short paper}, \emph{poster} o \emph{tool paper}) en foros de ingeniería de requisitos.
\end{itemize}
\end{notabox}
...
\begin{itemize}
    \item Preguntas de Investigación\footnote{En inglés: \emph{Research Question}, RQ, enunciado interrogativo que orienta y delimita el estudio empírico, y cuya respuesta constituye la contribución principal del manuscrito.} (RQ1, RQ2, RQ3) redactadas siguiendo el marco Población, Intervención, Comparación, Resultado, Contexto\footnote{En inglés: \emph{Population, Intervention, Comparison, Outcome, Context}, PICOC, marco para formular preguntas de investigación en revisiones sistemáticas y estudios empíricos en ingeniería de software, popularizado por Kitchenham y Charters.} (PICOC), útil para orientar tanto experimentos como estudios de caso \cite{kitchenham2007guidelines}.
...
\submark{6.1 Conjunto de datos abierto con licencia CC BY 4.0}
...
El paquete debe contener: transcripciones anonimizadas de las entrevistas en formato de Notación de Objetos de JavaScript\footnote{En inglés: \emph{JavaScript Object Notation}, JSON, formato ligero de intercambio de datos estandarizado en la ECMA-404 e ISO/IEC 21778.} (JSON) estructurado, respuestas del cuestionario en formato de Valores Separados por Comas\footnote{En inglés: \emph{Comma-Separated Values}, CSV, formato textual estandarizado por la RFC 4180 para el intercambio de datos tabulares.} (CSV), RF y RNF etiquetados en formato JSON, la matriz de trazabilidad en CSV, las consignas y las respuestas de los LLM (si aplican los enfoques 1 o 2 descritos en la Sección 5), scripts de análisis en R o en Python, y un archivo \texttt{README\_dataset.md} con el diccionario de datos.

\submark{6.2 Estructura del manuscrito (a producir en la Entrega 4)}
Sección de introducción con problema, motivación y contribuciones enumeradas; sección de trabajo relacionado que cubra al menos los tres últimos años; sección de metodología con el protocolo experimental; sección de resultados con tablas y figuras cuantitativas; sección de discusión que incluya el análisis de amenazas a la validez (\emph{threats to validity}) siguiendo la clasificación de \cite{wohlin2012experimentation}; sección de conclusiones y trabajo futuro; sección de disponibilidad de datos con el DOI de Zenodo.

\submark{6.3 Selección de la revista objetivo --- búsqueda por título y resumen}
El equipo no debe casarse con una revista determinada antes de tener el manuscrito redactado.
Una vez producidos el título y el resumen preliminar de la Entrega 3 (2A), y con mayor razón cuando el manuscrito esté avanzado en la Entrega 4 (2B), la persona autora principal ejecuta la búsqueda de la revista objetivo en las tres herramientas oficiales de las editoriales de alto impacto, comparando los resultados entre sí y evaluando cuál es el mejor ajuste temático y de política editorial.

\begin{longtable}{@{}L{0.20\linewidth} L{0.34\linewidth} L{0.40\linewidth}@{}}
    \hh{Editorial} & \hh{Herramienta oficial --- ingresar título y resumen} & \hh{Qué evaluar en el resultado}\\
    \endfirsthead
    \hh{Editorial} & \hh{Herramienta oficial --- ingresar título y resumen} & \hh{Qué evaluar en el resultado}\\
    \endhead
    Springer Nature & \rutafmt{https://journalsuggester.springer.com/} & Coincidencia temática con el alcance de la revista, cuartil JCR, tiempo medio a primera decisión, modalidad de acceso (por suscripción, acceso abierto por APC o híbrida), tarifa APC.\\
    Elsevier & \rutafmt{https://journalfinder.elsevier.com/} & Emparejamiento con revistas indexadas en Scopus; filtro por acceso abierto oro (\emph{gold OA}) o por suscripción; puntuación de coincidencia con el resumen; CiteScore y factor de impacto.\\
    IEEE & \rutafmt{https://publication-recommender.ieee.org/} & Coincidencia con revistas (\emph{transactions}, \emph{letters}) y con conferencias del área; factor de impacto; estado de acceso abierto y disponibilidad del enlace de envío; tiempo medio de revisión.\\
\end{longtable}

\submark{6.4 Búsqueda en modalidad mixta --- revistas con APC y revistas por suscripción}
Cada equipo debe registrar en el archivo \texttt{07\_Publicacion/analisis\_revistas.md} al menos dos candidatas de cada editorial: una en modalidad de acceso abierto con APC y otra en modalidad por suscripción o híbrida sin cargo obligatorio para las personas autoras.
La razón es que los equipos de pregrado pueden no disponer del financiamiento para pagar el APC (típicamente entre 1500 y 3500 dólares en las editoriales de alto impacto), por lo que deben tener siempre una alternativa por suscripción o híbrida sin cargo.
En la comparación se debe documentar, para cada candidata: nombre completo, editorial, indexación en JCR y cuartil vigente, factor de impacto, modelo de acceso, tarifa APC en dólares, tiempo medio a primera decisión, tasa de aceptación cuando esté publicada, y una justificación breve del ajuste temático con base en el título y en el resumen del propio manuscrito.

\begin{notabox}[title=Recomendación operativa]
Aunque un equipo tenga preferencia por una editorial en particular, la política del PFC es que el envío final se decida en la semana 16 comparando las candidatas de las tres editoriales.
No se acepta que la elección se justifique únicamente por familiaridad o por presencia previa en la editorial; la justificación debe estar sustentada por la puntuación de ajuste de la herramienta oficial, por la coherencia entre el resumen del manuscrito y el alcance publicado de la revista, y por la viabilidad económica y temporal del envío.
\end{notabox}
...
El manuscrito se redacta en LaTeX usando la plantilla oficial de la revista objetivo, descargada del sitio de la editorial correspondiente (Springer Nature, Elsevier o IEEE).
La extensión típica es de 15 a 20 páginas para un artículo completo (\emph{full research paper}) y de 6 a 8 páginas para un artículo corto (\emph{short paper}), un póster o un artículo de herramienta (\emph{tool paper}).
La categoría de envío se determina en función del volumen de datos empíricos alcanzado: los equipos que llegaron o superaron los mínimos evidenciales de la Sección 4 apuntan a artículo completo en revista indexada en JCR; los equipos que se quedaron entre el 50\% y el 100\% del mínimo apuntan a artículo corto o \emph{tool paper}; los equipos por debajo del 50\% del mínimo redirigen el manuscrito hacia una modalidad de póster o de demostración.
En todos los casos, la revista o el foro objetivo se selecciona con las herramientas oficiales listadas en la Sección 6.3, comparando al menos una alternativa con APC y una alternativa por suscripción o híbrida sin cargo.
...
\begin{longtable}{@{}L{0.22\linewidth} L{0.72\linewidth}@{}}
    ...
    \texttt{CITATION.cff} & Archivo en el lenguaje de serialización de datos legible por humanos\footnote{En inglés: \emph{YAML Ain't Markup Language}, YAML, formato de serialización de datos frecuentemente usado en archivos de configuración y en metadatos de repositorios.} (YAML) siguiendo el Formato de Archivo de Citación\footnote{En inglés: \emph{Citation File Format}, CFF, especificación estandarizada para describir cómo debe citarse un artefacto de software o un conjunto de datos.} versión 1.2.0 \cite{druskat2021cff}, con los campos \texttt{cff-version}, \texttt{message}, \texttt{authors} (incluyendo el Identificador de Persona Investigadora y Contribuidora Abierta\footnote{En inglés: \emph{Open Researcher and Contributor ID}, ORCID, identificador persistente e internacional que distingue de manera única a una persona investigadora y persiste a lo largo de toda su carrera profesional (\url{https://orcid.org}).} (ORCID) de cada integrante), \texttt{title}, \texttt{version}, \texttt{date-released} y \texttt{doi} (una vez publicado en Zenodo). Su presencia habilita el botón \emph{Cite this repository} de GitHub.\\
...
\begin{longtable}{@{}p{0.08\linewidth} p{0.28\linewidth} p{0.55\linewidth}@{}}
    ...
    17 & Entrega 4 (2B) y defensa final & Manuscrito completo listo para envío a la revista indexada en JCR seleccionada mediante las herramientas oficiales de la Sección 6.3, con análisis comparativo entre una candidata con APC y una candidata por suscripción o híbrida; defensa oral de 20 minutos.\\
\end{longtable}
